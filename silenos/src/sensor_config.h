...
int init_sensors(void)
{
    ...
    if (reed_sensor_driver_init(&registered_sensors[0].reed_sensor, &registered_sensors_params[0].reed_sensor_params) != 0){
    	return -1;
    }
    ...
    if (reed_sensor_driver_init(&registered_sensors[1].reed_sensor, &registered_sensors_params[1].reed_sensor_params) != 0){
    	return -1;
    }
