...
function decodeUplink(input) {
    ...
    var sid_bits = decoded_data.ib; // not necessarily needed at this level to identify sensor
    ...
    for (let index = 0; index < decoded_data.i.length; index++) {
        ...
        const event_counter = decoded_data.c[index]
        const latest_arrive_ticket = decoded_data.k[index]
        ...
        sensors.push({
            ...
            latest_arrive_ticket: latest_arrive_ticket
        });
    }
